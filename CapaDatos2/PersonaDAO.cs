...
namespace CapaDatos
{
    public static class PersonaDAO
    {
        ...
        private static String cadenaConexion = @"USER-PC\SQLEXPRESS; database=Estudiante; integrated security=true"; 
        public static int crear(Persona persona)
        {
            ...
            //definir un objeto de la clase Command para ejecutar la setencia sql que hemos creado
